...
namespace web.Utility
{
    public static class CacheCodes
    {
        ...
        public static string UNIT_LIST = "UNIT_LIST";
        public static string FISCALYEAR_LIST = "FISCALYEAR_LIST";
        public static string SUPPLIER_LIST = "SUPPLIER_LIST";
        ...
        public static string DESIGNATION_LIST = "DESIGNATION_LIST";
